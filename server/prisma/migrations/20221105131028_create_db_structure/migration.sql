/*
  ...
  - You are about to drop the column `date` on the `Guess` table. All the data in the column will be lost.
...
INSERT INTO "new_Guess" ("createdAt", "firstTeamPoints", "id", "secondTeamPoints") SELECT "createdAt", "firstTeamPoints", "id", "secondTeamPoints" FROM "Guess";
DROP TABLE "Guess";
